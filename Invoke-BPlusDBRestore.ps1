<#
.SYNOPSIS
    Wrapper script for backward compatibility with the original hpsBPlusDBRestore.ps1

.DESCRIPTION
    This script provides backward compatibility for users who are used to calling
    hpsBPlusDBRestore.ps1 directly. It imports the new module and calls the
...
.NOTES
    ...
    Restore-BPlusDatabase [parameters]
#>
...
if (Test-Path $modulePath) {
    ...
    Write-Error "BPlusDBRestore module not found at: $modulePath"
...
try {
    Restore-BPlusDatabase @moduleParams
}
catch {
