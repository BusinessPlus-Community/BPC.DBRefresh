function Show-BPlusConfiguration {
  <#
  .SYNOPSIS
  ...
  .PARAMETER Config
      The configuration hashtable from Get-BPlusEnvironmentConfig
  ...
  .EXAMPLE
      Show-BPlusConfiguration -Config $config -BackupFiles $files -TestingMode $false
  #>
  [CmdletBinding()]
  param(
